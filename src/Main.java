...
public class Main {
    ...
    private static void menuPrincipal() {
        ...
        while (opcao != 0) {
            ...
            System.out.println("║  2. Executar Cenário DEADLOCK                                ║");
            System.out.println("║  3. Executar Cenário STARVATION                              ║");
            System.out.println("║  4. Executar TODOS os cenários                               ║");
    ...
    private static void executarTodosCenarios() throws InterruptedException {
        System.out.println("\n═══════════════════════════════════════════════════════════════");
        System.out.println("            EXECUÇÃO DE TODOS OS CENÁRIOS");
        System.out.println("═══════════════════════════════════════════════════════════════\n");
